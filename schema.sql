...
CREATE TABLE IF NOT EXISTS shoes (
    ...
    shoe_material VARCHAR(20) NOT NULL CHECK (shoe_material IN ('Kanvas', 'Kulit', 'Mesh')), -- Untuk ML Input
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
-- 5. Table for Machine Learning Predictions (Supports both smell and drying predictions)
...
CREATE TABLE IF NOT EXISTS notifications (
    ...
    notification_type VARCHAR(20) DEFAULT 'INFO', -- e.g., INFO, WARNING, DANGER untuk warna alert UI
